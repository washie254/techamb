...
<div class="container">
	<div style="padding: 6px 12px; border: 1px solid #ccc;">
		<h3>ADMIN DASHBOARD FOR LAND APPLICATIONS</h3> 
		<p> Quick Links:
...
<div class="container" id="approved">
    <div style="padding: 6px 12px; border: 1px solid #ccc;height:auto; verflow: auto;">
        <h3>APPROVED MEMBER LANDS</h3> 
		<p> the following are the approved land applications</p> 
			...
			<tbody>
				...
				{	
					...
					echo '<tr>';
						...
						echo '<td>'.$row[1].'</td> '; //land id
						echo '<td>'.$row[2].'</td> '; //land title
						echo '<td>'.$row[4].'</td> '; // member
						echo '<td>'.$row[5].'</td> '; //date applied
						echo '<td>'.$row[3].'</td> '; //balance
						echo '<td>'.$row[6].'</td> '; //balance
					echo '</tr>';
				}
				?>
			</tbody>
...
<div class="container" id="pending">
    <div style="padding: 6px 12px; border: 1px solid #ccc;height:auto; verflow: auto;">
        <h3>PENDING MEMBER LANDS</h3> 
		<p> the following Pending applications</p> 
...
<div class="container" id="rejected">
    <div style="padding: 6px 12px; border: 1px solid #ccc;height:auto; verflow: auto;">
        <h3>REJECTED MEMBER LANDS</h3> 
		<p> the following are the Rejected land applications</p> 
