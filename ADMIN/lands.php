...
<div class="container">
	<div style="padding: 6px 12px; border: 1px solid #ccc;">
		<h3>ADMIN DASHBOARD FOR KENTOUR LANDS</h3> 
		<p> The following are the lands on the system</p>  
	</div>
</div>	
<br>
<div class="container">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				{	
					...
					echo '<tr>';
						echo '<td>'.$row[0].'</td> '; // ID
						echo '<td>'.$row[1].'<br><img height="150" width="280" src="../STAFF/lands/'.$row[4].'"></td> '; //IMAGE + TITLE
