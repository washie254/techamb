...
<div class="container">
	<div style="padding: 6px 12px; border: 1px solid #ccc;">
		...
		<p> Provide direct feedbak to the victim</p>  
        <?php
        ...
        <div class="container">
            ...
            <form method="post" action="advice.php">
                ...
                <div class="form-group">
                    <textarea type="text" class="form-control" name="Feedback" placeholder="Write brief feedback for the victim on how to solve the issue" required></textarea>
                </div>


                <input type="text" style="opacity:0;" name="incid" value="<?=$incid?>" readonly>

                <button type="submit" class="btn btn-primary" name="adminadv" style="width:100%;"><b>Provide Feedback</b></button>
                </a>
