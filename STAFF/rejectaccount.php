		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			...
			<li class="nav-item"><a class="nav-link" href="home.php">Home</a></li>
			  <li class="nav-item active">
			   ...
			   <li class="nav-item"><a class="nav-link" href="accounts.php">Membership Requests</a></li>
...
<div class="container">
	<div style="padding: 6px 12px; border: 1px solid #ccc;">
		...
		<p> Give reason for rejecting an account</p>  
        ...
        ?>
        <p> <b>USER ID: </b><?php echo $uid;?>
        <p> <b>USERNAME:</b> <?php echo $uname;?></p>


        <div class="container">

            <form method="post" action="rejectaccount.php">
                <style>
                    .error {
                        width: 98%; 
                        margin: 0px auto; 
                ...
                <div class="form-group">
                    <textarea type="password" class="form-control" name="reason" placeholder="Write a brief reason" ></textarea>
                </div>
                <input type="text" style="opacity:0;" name="userID" value="<?=$uid?>">
                <input type="text" style="opacity:0;" name="username" value="<?=$uname?>">
                <button type="submit" class="btn btn-success" rows="5" name="rejectreason" style="width:100%;"><b>REJECT ACCOUNT</b></button>
                <a href="acounts.php"> <button type="submit" class="btn btn-danger" name="rejectreason" style="width:100%;"><b>CANCEL</b></button></a>
