		...
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			  ...
			  <li class="nav-item active">
				<a class="nav-link" href="#">RESPOND<span class="sr-only">(current)</span></a>
			  </li>
			</ul>
		  </div>
		</div>
...
<div class="container">
    <div style="padding: 6px 12px; border: 1px solid #ccc;">
		...
		<p> Give a brief information as  your response
		    <?php
		        $sql = "SELECT * FROM enquiries WHERE id='$enqid'";
		    ...
		    <br><span><b>Subject: </b><?=$subject?></b></span><br>
		    <span><b>Message: </b> <?=$message?></b></span><br>
		</p>   
		...
		<style>
		  ...
		  <div class="form-group">
              ...
              <textarea type="text" class="form-control" name="feedback" rows="4" cols="50"placeholder="Enter brief messag for the reponse" required></textarea>
		  </div>
          <input name="enqid" value="<?=$enqid?>" style="opacity: 0.3;" readonly/>
		  <button type="submit" class="btn btn-success" name="respondenq" style="width:100%;"><b>Respond</b></button>
